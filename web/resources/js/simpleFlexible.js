		        ...
		        create: function(element) {
		            ...
		            if (!title) {
		                ...
		                if (!hasClose) {
		                    ...
		                    dialogHTML[0] = '<section id="' + id + '" class="dialog-box"><div class="dialog-box-container"><div class="dialog-box-title"><h2>' + title + '</h2><span class="dialog-box-close">×</span></div><div class="dialog-box-content"></div>';
		                }
		            }
